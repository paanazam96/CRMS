<?php   //including the database connection file 
    ...
    { 
        ...
        $result = mysqli_query($conn, "UPDATE unit SET unit_name='$unit' WHERE id='$id' ");
        
        echo "<script>alert('Unit Successfully Updated!'); window.location.href='detailadd.php?id=$id';</script>";
    }
?>
<?php
    $id = $_GET['id'];
                ...
                <div class="container">
                    <div class="card-body col-md-12">
                        ...
                        <div class="card-body col-md-12">                        
                            ...
                            <form action="unitedit.php" method="post" autocomplete="off">
                                <input type="text" class="form-control" name="unit" style="text-transform:uppercase;" value="<?php echo $unit; ?>" required>
                                <br>
                                <div class="form-row">
