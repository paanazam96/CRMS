<?php   //including the database connection file 
    ...
    { 
        ...
        $categoryname = mysqli_real_escape_string($conn, strtoupper($_POST['categoryname']));
        
        $result = mysqli_query($conn, "UPDATE category_name SET cat_name='$categoryname' WHERE id='$id' ");
        
        echo "<script>alert('Category Name Successfully Updated!'); window.location.href='detailadd.php?id=$id';</script>";
    }
?>
<?php
    $id = $_GET['id'];
    $result = mysqli_query($conn, "SELECT * FROM category_name WHERE id=$id");
                ...
                <div class="container">
                    <div class="card-body col-md-12">
                        ...
                        <div class="card-body col-md-12">                        
                            ...
                            <form action="categorynameedit.php" method="post" autocomplete="off">
                                <input type="text" class="form-control" name="categoryname" style="text-transform:uppercase;" value="<?php echo $categoryname; ?>" required>
                                <br>
                                <div class="form-row">
