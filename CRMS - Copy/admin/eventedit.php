...
<?php 
    ...
    if(isset($_POST['update']))
    {
        ...
        $result = mysqli_query($conn, "UPDATE events SET type='$type', 
                                        event='$event', 
                                        location='$location',
                                        start='$start',
                                        end='$end',
        ...
        echo "<script>alert('Event Successfully Updated!'); window.location.href='eventview.php?id=$id';</script>";
    }
?>
<html>
    <head>
            ...
            <div class="row">
                ...
                <div class="container">
                    <div class="card-body col-md-12">
                        <div class="row">
                            <div class="col">
                                <h1 style="font-family:Trebuchet MS; color:black;">Edit Event</h1>
                            </div>
                            <div class="col">
                                    
                            </div>
                        </div> 
                        <form action="eventedit.php" method="post" autocomplete="off">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="event" class="form-control" style="text-transform:uppercase;" value="<?php echo $event ?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="">Event Location</label>
                                    <input type="text" name="location" class="form-control" style="text-transform:uppercase;" value="<?php echo $location ?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="">Start Date/Time</label>
                                    <input type="date" class="form-control" id="pick_date" onchange="cal()" name="start" value="<?php echo $start ?>">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="">End Date/Time</label>
                                    <input type="date" class="form-control" id="drop_date" onchange="cal()" name="end" value="<?php echo $end ?>">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="">Number of Days</label>
                                    <input type="text" class="form-control" id="numdays2" name="days" value="<?php echo $days ?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <a href="eventview.php?id=<?php echo $id;?>" class="btn btn-danger btn-md float-left" role="button">Back</a>   
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="hidden" name="id" value="<?php echo $id;?>">
                                    <input type="submit" name="update" value="Update" class="btn btn-success btn-md float-right"> 
                                </div>
                            </div>
                        </form>
                    </div>
